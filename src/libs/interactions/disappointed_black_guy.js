...
module.exports = {
  ...
  .setName('disappointed_black_guy')
  .setDescription('Use the disappointed black guy meme and give it the parameters.')
  ...
  async execute(interaction) {
    ...
    meme.setImage(`${grasapiURL}disappointed_black_guy/?text1=${TextWithoutSpaces1}&text2=${TextWithoutSpaces2}`)
    meme.setTimestamp()
    meme.setFooter({ text: "Disappointed Black Guy Meme", iconURL: interaction.guild.iconURL() })
