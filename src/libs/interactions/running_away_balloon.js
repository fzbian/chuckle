...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('running_away_balloon')
    .setDescription('Use the running away balloon meme and give it the parameters.')
  ...
  async execute(interaction) {
    ...
    await interaction.reply(`${grasapiURL}running_away_balloon/?text1=${texto1}&text2=${texto2}`)
  }
}