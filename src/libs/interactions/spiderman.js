...
module.exports = {
  ...
  .setName('spiderman')
  .setDescription('Use the spiderman meme and give it the parameters.')
  ...
  async execute(interaction) {
    ...
    meme.setImage(`${GrasapiURL}spiderman/?text1=${TextWithoutSpaces1}&text2=${TextWithoutSpaces2}`)
    meme.setTimestamp()
    meme.setFooter({ text: "Spiderman Meme", iconURL: interaction.guild.iconURL() })
