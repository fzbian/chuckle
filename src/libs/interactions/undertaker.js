...
module.exports = {
  ...
  .setName('undertaker')
  .setDescription('Use the undertaker meme and give it the parameters.')
  ...
  async execute(interaction) {
    ...
    meme.setImage(`${GrasapiURL}undertaker/?text1=${TextWithoutSpaces1}&text2=${TextWithoutSpaces2}`)
    meme.setTimestamp()
    meme.setFooter({ text: "Undertaker Meme", iconURL: interaction.guild.iconURL() })
