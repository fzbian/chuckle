...
module.exports = {
  ...
  .setName('zoolander')
  .setDescription('Use the zoolander meme and give it the parameters.')
  ...
  async execute(interaction) {
    ...
    meme.setImage(`${grasapiURL}zoolander/?text1=${TextWithoutSpaces1}&text2=${TextWithoutSpaces2}`)
    meme.setTimestamp()
    meme.setFooter({ text: "Zoolander Meme", iconURL: interaction.guild.iconURL() })
